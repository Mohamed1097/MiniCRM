    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href={{route('users.index')}} class="nav-link @if (getUrl( url()->current(),'users'))
              active
            @endif">
          ...
          <li class="nav-item">
            <a href={{route('change-password')}} class="nav-link @if (getUrl( url()->current(),'change-password'))
              active
            @endif">
          ...
          <li class="nav-item">
            <a href={{route('companies.index')}} class="nav-link @if (getUrl( url()->current(),'companies'))
              active
            @endif">
          ...
          <li class="nav-item">
            <a href={{route('contacts.index')}}  class="nav-link @if (getUrl( url()->current(),'contacts'))
              active
            @endif">
            <i class="fas fa-user nav-icon"></i>
              <p> Contacts</p>
